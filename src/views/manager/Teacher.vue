  ...
  <div class="teacher-container">
    ...
    <div class="content-card">
      <div class="table-header">
        <h3 class="table-title">教师信息列表</h3>
        <el-button type="primary" @click="handleAdd" :icon="Plus" class="add-button">新增教师</el-button>
      </div>
      ...
      >
        ...
        <el-table-column label="职称" prop="title" width="100" align="center">
          <template #default="scope">
            <el-tag :type="getTagType(scope.row.title)" size="small">
              {{ scope.row.title }}
            </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="角色" prop="role" width="100" align="center">
          <template #default="scope">
            <el-tag type="primary" v-if="scope.row.role === 'TEACHER'">教师</el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog 
      ...
      :title="data.form.id ? '编辑教师信息' : '新增教师信息'" 
      width="500px"
      :close-on-click-modal="false" 
      destroy-on-close
      center
    >
      <el-form :model="data.form" label-width="80px" class="teacher-form">
